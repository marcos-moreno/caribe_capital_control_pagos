...
class GroupsActivity : BaseLocationActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            com.emprendamos.mx.emprendamosfin.R.id.action_sync -> {
                syncData()
            }
            com.emprendamos.mx.emprendamosfin.R.id.action_logout -> {
                launch {
                    prefHelper.setLogged(false)
                    runOnUiThread {
                        val intent = Intent(this@GroupsActivity, com.emprendamos.mx.emprendamosfin.LoginActivity::class.java)
            ...
            com.emprendamos.mx.emprendamosfin.R.id.action_close -> {
                Toast.makeText(this@GroupsActivity,"¡Adios!", Toast.LENGTH_SHORT).show()
                finish()
            }
            com.emprendamos.mx.emprendamosfin.R.id.action_free -> {
                presenter.freeApp {
                    wasSuccessful ->
                        runOnUiThread {
                            if (wasSuccessful) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.emprendamos.mx.emprendamosfin.R.layout.activity_groups)
    ...
    override fun onResume() {
        ...
        exp_list_groups.setOnChildClickListener { parent, view, groupPosition, childPosition, id ->
            ...
            var intent = Intent(this@GroupsActivity, com.emprendamos.mx.emprendamosfin.MainActivity::class.java)
            intent.putExtra(com.emprendamos.mx.emprendamosfin.MainActivity.Companion.ARGUMENT_PAY_CONTROL, sequence.paycontrol_id)
            intent.putExtra(com.emprendamos.mx.emprendamosfin.MainActivity.Companion.ARGUMENT_GROUP, sequence.paycontrol?.group_id ?: 0)
            intent.putExtra(com.emprendamos.mx.emprendamosfin.MainActivity.Companion.ARGUMENT_CICLE, sequence.paycontrol?.cycle ?: 0)
            intent.putExtra(com.emprendamos.mx.emprendamosfin.MainActivity.Companion.ARGUMENT_SEQUENCE, sequence.sequence)
            intent.putExtra(com.emprendamos.mx.emprendamosfin.MainActivity.Companion.ARGUMENT_DATE, sequence.paycontrol!!.date)
            intent.putExtra(com.emprendamos.mx.emprendamosfin.MainActivity.Companion.ARGUMENT_IS_EDIT, !isTemplateRegister(sequence.paycontrol!!))
            intent.putExtra(com.emprendamos.mx.emprendamosfin.MainActivity.Companion.ARGUMENT_REGISTER_TYPE, sequence.type)
            intent.putExtra(com.emprendamos.mx.emprendamosfin.MainActivity.Companion.ARGUMENT_OBSERVATIONS, sequence.observation)
