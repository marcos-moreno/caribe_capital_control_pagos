...
class GroupsView(activity : com.emprendamos.mx.emprendamosfin.GroupsActivity) : BaseView<com.emprendamos.mx.emprendamosfin.GroupsActivity>(activity)
{
    ...
    fun init() {
        ...
        activity.toolbar.navigationIcon = ResourcesCompat.getDrawable(activity.resources, R.mipmap.ic_launch, null)
    }
